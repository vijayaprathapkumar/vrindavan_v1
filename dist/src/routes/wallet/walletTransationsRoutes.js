...
router.get("/log/:userId", authMiddleware_1.verifyDeviceToken, walletBalanceController_1.getWalletLogsAdmin);
...
router.get("/balances/:userId", authMiddleware_1.verifyDeviceToken, walletBalanceController_1.getWalletBalanceByUserIdAdmin);
