...
router.post("/", authMiddleware_1.verifyDeviceToken, foodController.addFood);
router.put("/:id", authMiddleware_1.verifyDeviceToken, foodController.modifyFood);
router.delete("/:id", authMiddleware_1.verifyDeviceToken, foodController.removeFood);
router.post("/stocks", authMiddleware_1.verifyDeviceToken, foodController.modifyStock);
