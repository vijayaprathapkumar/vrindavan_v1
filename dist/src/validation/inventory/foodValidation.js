...
exports.foodValidation = [
    ...
    (0, express_validator_1.body)('perma_link')
        .isString()
        .withMessage('Permanent Link must be a string'),
    ...
    (0, express_validator_1.body)('sku_code')
        .isString()
    ...
    (0, express_validator_1.body)('cgst')
        .isString()
        .withMessage('CGST must be a string'),
    (0, express_validator_1.body)('sgst')
        .isString()
        .withMessage('SGST must be a string'),
    ...
    (0, express_validator_1.body)('deliverable')
        .isBoolean()
