...
const stockCountRoutes_1 = __importDefault(require("./routes/inventory/stockCountRoutes"));
const orderStatusRoutes_1 = __importDefault(require("./routes/orderStatus/orderStatusRoutes"));
const routeOrderRoutes_1 = __importDefault(require("./routes/orderAdmin/routeOrderRoutes"));
const hubsOrderRoutes_1 = __importDefault(require("./routes/orderAdmin/hubsOrderRoutes"));
const localityOrderRoutes_1 = __importDefault(require("./routes/orderAdmin/localityOrderRoutes"));
const deliveryBoyOrdersRoutes_1 = __importDefault(require("./routes/orderAdmin/deliveryBoyOrdersRoutes"));
...
router.use("/stock_count", stockCountRoutes_1.default);
// Customers
...
router.use("/order-service-status", orderStatusRoutes_1.default);
// admin orders
router.use("/routeOrders", routeOrderRoutes_1.default);
router.use("/hubOrders", hubsOrderRoutes_1.default);
router.use("/localityOrders", localityOrderRoutes_1.default);
router.use("/deliveryOrder", deliveryBoyOrdersRoutes_1.default);
