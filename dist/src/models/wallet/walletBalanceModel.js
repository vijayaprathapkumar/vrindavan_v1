...
exports.getWalletBalanceUserIdAdmin = exports.getWalletLogsWithFoodDetailsAdmin = exports.getWalletLogsWithFoodDetails = exports.getWalletBalanceByWithOutUserId = exports.getWalletBalanceByUserId = void 0;
...
const getWalletLogsWithFoodDetailsAdmin = async (userId, page, limit) => {
    try {
        const offset = (page - 1) * limit;
    ...
    `;
      ...
      `;
            const [foodOrderRows] = await databaseConnection_1.db
                .promise()
...
exports.getWalletLogsWithFoodDetailsAdmin = getWalletLogsWithFoodDetailsAdmin;
const getWalletBalanceUserIdAdmin = async (userId, page, limit, startDate, endDate, searchTerm, sortField, sortOrder) => {
    const offset = (page - 1) * limit;
    let baseQuery = `
    FROM 
      wallet_balances wb
  ...
  `;
    ...
    try {
        ...
        const [walletBalances] = await databaseConnection_1.db
            ...
            .query(dataQuery, params);
        return {
            walletBalancesData: walletBalances.length > 0 ? walletBalances : null,
            totalCount,
        };
    }
    catch (error) {
...
exports.getWalletBalanceUserIdAdmin = getWalletBalanceUserIdAdmin;
