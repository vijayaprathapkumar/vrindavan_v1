...
exports.getLocalityOrderSummaryAdmin = exports.getLocalityOrdersAdmin = void 0;
const databaseConnection_1 = require("../../config/databaseConnection");
const getLocalityOrdersAdmin = async (page, limit, localityId, startDate, endDate, searchTerm, productId) => {
...
exports.getLocalityOrdersAdmin = getLocalityOrdersAdmin;
const getLocalityOrderSummaryAdmin = async (page, limit, localityId, startDate, endDate, searchTerm) => {
    const offset = (page - 1) * limit;
    let conditions = "WHERE o.locality_id IS NOT NULL";
    const queryParams = [];
    if (localityId) {
...
`;
    ...
    ${conditions}
  `;
    const [summaryData] = await databaseConnection_1.db
        .promise()
...
exports.getLocalityOrderSummaryAdmin = getLocalityOrderSummaryAdmin;
