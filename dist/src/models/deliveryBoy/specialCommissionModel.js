...
exports.updateSpecialCommission = exports.getDetailedSpecialCommissionById = exports.getAllDetailedSpecialCommissions = void 0;
const databaseConnection_1 = require("../../config/databaseConnection");
const getAllDetailedSpecialCommissions = async (searchTerm = "", limit = 10, offset = 0, categoryId = "", deliveryBoyId = "", sortField, sortOrder) => {
    const searchPattern = `%${searchTerm}%`;
    const categoryFilter = categoryId && categoryId !== "All" ? " AND sc.category_id = ?" : "";
    const deliveryBoyFilter = deliveryBoyId && deliveryBoyId !== "All"
...
const updateSpecialCommission = async (commissionId, specialCommissionValue) => {
    const query = `
  ...
  `;
    const [result] = await databaseConnection_1.db
        .promise()
        .query(query, [specialCommissionValue, commissionId]);
