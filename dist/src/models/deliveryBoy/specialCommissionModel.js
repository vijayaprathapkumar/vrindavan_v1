...
exports.updateSpecialCommission = exports.getDetailedSpecialCommissionById = exports.getAllDetailedSpecialCommissions = exports.addSpecialCommission = void 0;
const databaseConnection_1 = require("../../config/databaseConnection");
const addSpecialCommission = async (categoryId, productId, standardCommission, specialCommission, deliveryBoyId) => {
    const query = `
...
exports.addSpecialCommission = addSpecialCommission;
const getAllDetailedSpecialCommissions = async (searchTerm = "", limit = 10, offset = 0, categoryId = "", deliveryBoyId = "", sortField = "", sortOrder = "asc") => {
    const searchPattern = `%${searchTerm}%`;
    const categoryFilter = categoryId && categoryId !== "All" && !isNaN(parseInt(categoryId))
        ? " AND c.id = ?"
        : "";
    ...
    try {
        ...
        console.error("Error fetching detailed special commissions:", error.message);
        throw error;
    }
};
exports.getAllDetailedSpecialCommissions = getAllDetailedSpecialCommissions;
const getDetailedSpecialCommissionById = async (id) => {
...
exports.getDetailedSpecialCommissionById = getDetailedSpecialCommissionById;
const updateSpecialCommission = async (id, categoryId, productId, standardCommission, specialCommission, deliveryBoyId) => {
    const query = `
...
exports.updateSpecialCommission = updateSpecialCommission;
