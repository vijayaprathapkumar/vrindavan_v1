...
exports.getDetailedCommissionById = exports.getAllDetailedCommissions = void 0;
const databaseConnection_1 = require("../../config/databaseConnection");
// Fetch all detailed commissions with search and pagination
const getAllDetailedCommissions = async (searchTerm = '', limit = 10, offset = 0, categoryId = '') => {
...
`;
    ...
    const [[{ total_count }]] = await databaseConnection_1.db.promise().query(queryCount, countParams);
