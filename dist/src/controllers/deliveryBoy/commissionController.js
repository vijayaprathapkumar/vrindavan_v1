...
const updateCommissionController = async (req, res) => {
    ...
    try {
        ...
        if (updatedCommission) {
            res.status(200).json((0, responseHandler_1.createResponse)(200, "Commission updated successfully", updatedCommission));
        }
        else {
        ...
        res.status(500).json((0, responseHandler_1.createResponse)(500, "Error updating commission", error));
    }
};
