...
const getDeliveryBoysWithLocalities = async (req, res) => {
    try {
        ...
        const sortOrder = req.query.sortOrder
            ? req.query.sortOrder
            : "";
        const { deliveryBoys, totalCount } = await (0, deliveryBoyModel_1.getAllDeliveryBoysWithLocalities)(limit, offset, searchTerm, sortField.toString(), sortOrder.toString());
...
const updateDeliveryBoy = async (req, res) => {
    ...
    try {
        ...
        res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error updating delivery boy", error));
    }
    finally {
        connection.release();
    }
