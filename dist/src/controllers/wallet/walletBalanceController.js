...
exports.getWalletBalanceByUserIdAdmin = exports.getWalletLogsAdmin = exports.getWalletLogs = exports.getWalletBalanceWithOutUserId = exports.getWalletBalance = void 0;
...
const getWalletLogsAdmin = async (req, res) => {
    const { userId } = req.params;
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
    try {
        const { data: walletLogs, totalCount } = await (0, walletBalanceModel_1.getWalletLogsWithFoodDetailsAdmin)(userId, page, limit);
        ...
        const totalPages = Math.ceil(totalCount / limit);
        return res.status(200).json((0, responseHandler_1.createResponse)(200, "Wallet logs retrieved successfully", {
            walletLogs,
            currentPage: page,
            limit,
            totalCount,
...
exports.getWalletLogsAdmin = getWalletLogsAdmin;
const getWalletBalanceByUserIdAdmin = async (req, res) => {
    try {
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
        const startDate = req.query.startDate;
        ...
        if (!userId) {
            return res.status(400).json((0, responseHandler_1.createResponse)(400, "User ID is required"));
        }
        const { walletBalancesData, totalCount } = await (0, walletBalanceModel_1.getWalletBalanceUserIdAdmin)(userId, page, limit, startDate, endDate, searchTerm, sortField, sortOrder);
...
exports.getWalletBalanceByUserIdAdmin = getWalletBalanceByUserIdAdmin;
