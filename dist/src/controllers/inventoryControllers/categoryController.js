...
const categoryModel_1 = require("../../models/inventoryModels/categoryModel");
...
const addCategory = async (req, res) => {
    ...
    try {
        ...
        res
            .status(201)
            .json((0, responseHandler_1.createResponse)(201, "Category created successfully"));
    }
    catch (error) {
        res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error creating category", error));
    }
};
...
const updateCategory = async (req, res) => {
    ...
    try {
        ...
        res
            .status(200)
            .json((0, responseHandler_1.createResponse)(200, "Category updated successfully"));
    }
    catch (error) {
        res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error updating category", error));
    }
};
...
const deleteCategory = async (req, res) => {
    ...
    try {
        ...
        res
            .status(200)
            .json((0, responseHandler_1.createResponse)(200, "Category deleted successfully"));
    }
    catch (error) {
        res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error deleting category", error));
    }
};
