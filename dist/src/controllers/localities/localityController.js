...
const updateLocality = async (req, res) => {
    const { id } = req.params;
    const { route_id, hub_id, name, address, google_address, latitude, longitude, city, active, deliveryBoyId } = req.body;
    try {
        await (0, localityModel_1.updateLocalityById)(parseInt(id), route_id, hub_id, name, address, google_address, latitude, longitude, city, active, deliveryBoyId);
        res.status(200).json({
            statusCode: 200,
