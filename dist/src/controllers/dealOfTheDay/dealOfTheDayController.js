...
const fetchDeals = async (req, res) => {
    ...
    try {
        ...
        return res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error fetching deals.", error.message));
    }
};
...
const addDeal = async (req, res) => {
    ...
    try {
        ...
        return res
            .status(201)
            .json((0, responseHandler_1.createResponse)(201, "Deal created successfully."));
    }
    catch (error) {
        console.error("Error creating deal:", error);
        return res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error creating deal.", error.message));
    }
};
...
const fetchDealById = async (req, res) => {
    ...
    try {
        ...
        return res
            .status(200)
            .json((0, responseHandler_1.createResponse)(200, "Deal fetched successfully.", response));
    }
    catch (error) {
        console.error("Error fetching deal:", error);
        return res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error fetching deal.", error.message));
    }
};
...
const updateDeal = async (req, res) => {
    ...
    try {
        ...
        if (result.affectedRows > 0) {
            return res
                .status(200)
                .json((0, responseHandler_1.createResponse)(200, "Deal updated successfully."));
        }
        else {
            return res.status(404).json((0, responseHandler_1.createResponse)(404, "Deal not found."));
        }
        ...
        return res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error updating deal.", error.message));
    }
};
...
const removeDeal = async (req, res) => {
    ...
    try {
        ...
        if (result.affectedRows > 0) {
            return res
                .status(200)
                .json((0, responseHandler_1.createResponse)(200, "Deal deleted successfully."));
        }
        else {
            return res.status(404).json((0, responseHandler_1.createResponse)(404, "Deal not found."));
        }
        ...
        return res
            .status(500)
            .json((0, responseHandler_1.createResponse)(500, "Error deleting deal.", error.message));
    }
};
