...
exports.getCalendarWiseOneTimeOrders = exports.getCalendarWiseOrders = exports.cancelOneTimeOrder = exports.getUpcomingOrders = exports.cancelSubscriptionOrder = exports.removeOrder = exports.updateOrderQty = exports.fetchOrderById = exports.fetchAllOrdersWithOutUserID = exports.fetchAllOrders = void 0;
...
const getCalendarWiseOneTimeOrders = async (req, res) => {
    const userId = parseInt(req.params.userId, 10);
    const { startDate, endDate } = req.query;
    // Validate userId and date parameters
    if (isNaN(userId)) {
    ...
    try {
        const calendarData = await (0, orderModel_1.getCalendarOneTimeOrdersModel)(userId, parsedStartDate, parsedEndDate);
        const filteredResults = calendarData.filter((result) => result.order_id !== null);
        res.status(200).json((0, responseHandler_1.createResponse)(200, "Calendar-wise One time orders fetched successfully.", {
...
exports.getCalendarWiseOneTimeOrders = getCalendarWiseOneTimeOrders;
