...
const getCategories = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json((0, responseHandler_1.createResponse)(500, "Error fetching categories", error.message));
    }
};
...
const addCategory = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json((0, responseHandler_1.createResponse)(500, "Error creating category", error.message));
    }
};
...
const updateCategory = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json((0, responseHandler_1.createResponse)(500, "Error updating category", error.message));
    }
};
...
const deleteCategory = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json((0, responseHandler_1.createResponse)(500, "Error deleting category", error.message));
    }
};
