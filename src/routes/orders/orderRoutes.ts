...
import {
  ...
  fetchOrderById,
  getCalendarWiseOneTimeOrders,
  getCalendarWiseOrders,
  getUpcomingOrders,
  removeOrder,
  updateOrderQty,
...
router.get('/calender/:userId', getCalendarWiseOrders);

router.get('/calenderOneTime/:userId', getCalendarWiseOneTimeOrders);
