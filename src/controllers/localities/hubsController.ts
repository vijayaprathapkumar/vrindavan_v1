...
export const getHubs = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    const { hubs, totalRecords } = await getAllHubs(
      page,
      limit,
      searchTerm,
      sortField,
    ...
    res
      .status(500)
      .json(createResponse(500, "Error fetching hubs", error.message));
  }
};
...
export const addHub = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res
      .status(500)
      .json(createResponse(500, "Error creating hub", error.message));
  }
};
...
export const getHub = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res
      .status(500)
      .json(createResponse(500, "Error fetching hub", error.message));
  }
};
...
export const updateHub = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res
      .status(500)
      .json(createResponse(500, "Error updating hub", error.message));
  }
};
...
export const deleteHub = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    res
      .status(500)
      .json(createResponse(500, "Error deleting hub", error.message));
  }
};
